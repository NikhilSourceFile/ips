                    ...
                    <div class="blog-details-desc">
                        ...
                        <div class="comments-area">
                            ...
                            <div class="comment-respond">
                                ...
                                @else
                                    <form method="POST" action="bloggerdetails" class="comment-form">
                                        @csrf
                                        ...
                                        <p class="comment-form-author">
                                            ...
                                            <input type="text" placeholder="Your Name*" name="b_name">
                                            @error('b_name')
                                        ...
                                        <p class="comment-form-email">
                                            ...
                                            <input type="email" placeholder="Your Email*" name="b_email">
                                            @error('b_email')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </p>
                                        <p class="comment-form-url">
                                            <label>Website</label>
                                            <input type="url" placeholder="Website" name="b_url">
                                            @error('b_url')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </p>
                                        <p class="comment-form-comment">
                                            <label>Comment</label>
                                            <textarea name="b_comment" cols="45" placeholder="Your Comment..." rows="5" maxlength="65525"></textarea> 
                                            @error('b_comment')
                                                <span class="text-danger">{{$message}}</span>
                                            @enderror
                                        </p>
                                        <p class="comment-form-cookies-consent">
                                            <input type="checkbox" value="1" name="toc" id="wp-comment-cookies-consent">
                        ...
                        <section class="widget widget_ketan_posts_thumb">
                            ...
                            <article class="item">
                                ...
                                <div class="info">
                                    ...
                                    <h4 class="title usmall"><a href="#">Conversion Rate the Sales Funnel Optimization</a>
                                    </h4>
                                </div>
                            </article>
                            <article class="item">
                                ...
                                <div class="info">
                                    ...
                                    <h4 class="title usmall"><a href="#">Business Data is changing the world’s Energy</a>
                                    </h4>
                                </div>
                            </article>
                            <article class="item">
                                ...
                                <div class="info">
                                    ...
                                    <h4 class="title usmall"><a href="#">The Billionaire Guide On Design That Will Get
                                            You Rich</a></h4>
                                </div>
                            </article>
                            <article class="item">
                                ...
                                <div class="info">
                                    ...
                                    <h4 class="title usmall"><a href="#">The Data-Driven Approach To Understanding Your
                                            Users</a></h4>
                                </div>
                            </article>
                            <article class="item">
                                ...
                                <div class="info">
                                    ...
                                    <h4 class="title usmall"><a href="#">7 Great Tips For Earn More Money From Digital
                                            Industry</a></h4>
                                </div>
                            </article>
                        </section>
